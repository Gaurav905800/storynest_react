...
import { editBlog, detailBlog } from "../redux/slice/blogSlice";
...
function EditBlog() {
  ...
  useEffect(() => {
    if (selectedBlog && selectedBlog._id === id) {
      ...
      setTags(selectedBlog.tags ? selectedBlog.tags.join(", ") : "");
      setPreview(selectedBlog.image || null);
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(editBlog({ id, formData, token }))
      .unwrap()
      .then(() => {
        setSuccess(true);
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 bg-white rounded-xl shadow-2xl">
      ...
      <p className="text-gray-600 mb-8">
        Update your existing post details below.
      </p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                placeholder="e.g. react, nodejs, ux"
                className={inputClass("tags")}
              />
            </div>
          </div>

          {/* Image Upload + Publish */}
          <div className="flex flex-col gap-6">
            <div className="flex flex-col">
              <label className="text-lg font-semibold text-gray-700 flex items-center gap-2">
        ...
        <div className="pt-6 border-t border-gray-100 flex flex-col items-center">
          ...
          >
            {loading ? (
              ...
              <>
                <Send className="w-5 h-5" /> Update Blog
              </>
            )}
          </button>
