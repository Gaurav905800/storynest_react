...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-6 md:px-12 lg:px-20">
      ...
      <div className="max-w-xl mx-auto mb-8">
        <div className="relative">
          <input
            ...
            className="w-full py-3 pl-12 pr-4 text-gray-700 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-150 shadow-sm"
          />
      ...
      <div className="flex justify-center items-center gap-4 mb-8 flex-wrap ">
        {["All", ...categories].map((item) => (
          <div
            ...
            className={`px-4 py-2 rounded-full cursor-pointer select-none transition-all border ${
      ...
      ) : categorizedBlogs.length === 0 && selectedCategory !== "All" ? (
        <p className="text-center text-gray-600 text-xl font-medium pt-8">
